...
\def\thesistitle{Tree‑Based Multi‑Output Regression for Near Real‑Time Performance Prediction in VR Flight Training}                      % title
...
Figures:
All figures in this thesis were generated by the author using the analysis code developed for this project, based on the dataset and derived model outputs. No externally created images or figures were reused.
