...
def plot_true_vs_pred_scatter(
    ...
    plt.xlabel(f"True {key_output}", fontsize=12)
    plt.ylabel(f"Predicted {key_output}", fontsize=12)
    plt.title(f"True vs predicted {key_output}", fontsize=14)
...
def plot_correlations_vs_true_total_error(
    ...
    plt.xlabel("True Total Error", fontsize=12)
    plt.ylabel("Value", fontsize=12)
    plt.title("Correlations with true total error", fontsize=14)
