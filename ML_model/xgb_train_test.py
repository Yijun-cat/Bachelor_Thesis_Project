...
df_model_pd, feat_cols, target_cols = construct_df(['03', '04', '05'])
X = df_model_pd[feat_cols].to_numpy()
y = df_model_pd[target_cols].to_numpy()

best_model, best_params = xgb_train(df_model_pd, X, y, cv_method='logo')
