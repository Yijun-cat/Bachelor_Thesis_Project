...
best_model, best_params = xgb_train(df_model, X_gpu, y_gpu, cv_method='logo')
...
for train_id, test_id in logo.split(X_gpu, y_gpu, groups):
    X_train, X_test = X_gpu[train_id], X_gpu[test_id]
    y_train, y_test = y_gpu[train_id], y_gpu[test_id]
